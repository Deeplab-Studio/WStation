...
// ISR attribute makrosu
#if defined(ESP8266)
  #define WEATHER_ISR_ATTR ICACHE_RAM_ATTR
#else
  #define WEATHER_ISR_ATTR
#endif
...
class SFEWeatherMeterKit
{
  ...
  private:
    ...
    // Interrupt handlers
    static void WEATHER_ISR_ATTR windSpeedInterrupt();
    static void WEATHER_ISR_ATTR rainfallInterrupt();
